...
def creation_de_la_liste_de_course(seuil_pour_acheter_pourcentage_du_nombre_de_produits_par_lots):
...
def diff(course, seuil):
    csv_writer(f'CourseDiff{seuil}pourcent.csv', list(set(course) - set(creation_de_la_liste_de_course(seuil))))

if __name__ == '__main__':
    course = creation_de_la_liste_de_course(100)
